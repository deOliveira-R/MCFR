...
path = '/Users/rodrigo/git/nuclear/MCBR/ATARI/fluidDynamics_noBaffle/'
...
fluidDynamics = OpenFOAMReader(registrationName='fluidDynamics_noBaffle.foam', FileName=path + 'fluidDynamics_noBaffle.foam')
...
# nutLUTColorBar.CustomLabels = [0.012, 0.01, 0.008, 0.006, 0.004, 0.002]
